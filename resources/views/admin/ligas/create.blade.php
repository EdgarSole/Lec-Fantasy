<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Crear nueva liga</h2>
            <a href="{{ route('admin.dashboard') }}" class="px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-sm font-semibold text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600">Volver</a>
        </div>
    </x-slot>
    ...
    <div class="py-8 bg-gray-100 dark:bg-gray-900 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 px-4">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200/70 dark:border-gray-700/70 p-6">
                <form method="POST" action="{{ route('admin.ligas.store') }}" enctype="multipart/form-data" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" rows="3" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200">{{ old('descripcion') }}</textarea>
                    ...
                    <div>
                        ...
                        <select name="tipo" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200">
                            <option value="publica" {{ old('tipo') === 'publica' ? 'selected' : '' }}>Pública</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="contrasena" value="{{ old('contrasena') }}" class="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200">
                    ...
                    <div class="flex justify-end space-x-3 pt-4">
                        <a href="{{ route('admin.dashboard') }}" class="px-4 py-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-sm font-semibold text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600">Cancelar</a>
                        <button type="submit" class="px-4 py-2 rounded-lg bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700">Crear liga</button>
                    </div>
                </form>
            </div>
        </div>
