    ...
    <div class="flex h-screen bg-gray-50">
        ...
        <div class="w-64 bg-gradient-to-b from-gray-50 to-gray-100 shadow-lg border-r border-gray-200 flex flex-col">
            ...
            <nav class="flex-1 flex flex-col justify-between py-6 px-3 space-y-2">
                <div class="space-y-2">
                    <a href="{{ route('mi-liga', $liga) }}" class="flex items-center py-4 px-4 rounded-lg bg-blue-100 text-blue-700 font-medium hover:bg-blue-200 transition-all duration-200 border-l-4 border-blue-500">
                        <svg class="w-5 h-5 mr-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path>
                        </svg>
                        Mi Liga
                    </a>
                    <a href="{{ route('actividad', $liga) }}" class="flex items-center py-4 px-4 rounded-lg text-gray-700 font-medium hover:bg-gray-200 transition-all duration-200 border-l-4 border-transparent">
                    ...
                    <a href="{{ route('mi-equipo', $liga) }}" class="flex items-center py-4 px-4 rounded-lg text-gray-700 font-medium hover:bg-gray-200 transition-all duration-200 border-l-4 border-transparent">
                        <svg class="w-5 h-5 mr-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        Mi Equipo
                    </a>
                    <a href="{{ route('mercado', $liga) }}" class="flex items-center py-4 px-4 rounded-lg text-gray-700 font-medium hover:bg-gray-200 transition-all duration-200 border-l-4 border-transparent">
                        <svg class="w-5 h-5 mr-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                        Mercado
                    </a>
                    <a href="{{ route('clasificacion', $liga) }}" class="flex items-center py-4 px-4 rounded-lg text-gray-700 font-medium hover:bg-gray-200 transition-all duration-200 border-l-4 border-transparent">
                        <svg class="w-5 h-5 mr-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
