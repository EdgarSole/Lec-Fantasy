...
<x-app-layout>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300" x-data="{ sidebarOpen: true }">
        <!-- Menú lateral -->
         ...
         >
            ...
            <nav class="flex-1 flex flex-col justify-between py-6 px-3 space-y-2">
                <div class="space-y-2">
                    ...
                    class="flex items-center py-4 px-4 rounded-lg font-medium transition-colors duration-150l   border-l-4
