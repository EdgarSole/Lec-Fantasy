...
<div class="min-h-screen bg-gray-900 py-8 gaming-background">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="min-h-screen bg-gray-900/50 py-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div id="flash-notification" class="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-xl px-4 hidden">
                    <div class="relative bg-gray-800 rounded-xl border-2 border-purple-500 p-5 shadow-2xl overflow-hidden gaming-notification">
                        ...
                        <div class="flex items-start">
                            ...
                            <!-- Contenido -->
                            <div class="flex-1">
                                <h3 class="font-bold text-xl mb-1 flash-title tracking-wider text-white"></h3>
                ...
                @if(session('success'))
                    <div class="mt-4 mb-6 p-4 rounded-lg border-2 border-green-400 bg-gradient-to-br from-green-900/80 to-gray-900 text-green-100 shadow-lg shadow-green-500/20 relative overflow-hidden gaming-notification">
                ...
                @if(session('error'))
                    <div class="mt-4 mb-6 p-4 rounded-lg border-2 border-red-400 bg-gradient-to-br from-red-900/80 to-gray-900 text-red-100 shadow-lg shadow-red-500/20 relative overflow-hidden error-notification">
                ...
                <div class="text-center mb-12">
                    <h1 class="text-4xl font-extrabold text-white sm:text-5xl sm:tracking-tight lg:text-6xl gaming-title">
                        Mi Equipo
                    </h1>
                    <h2 class="mt-3 text-2xl font-semibold text-purple-400 neon-text">
                        Liga: {{ $liga->nombre }}
                    </h2>
                </div>

                <!-- Valor total del equipo -->
                <div class="bg-gradient-to-r from-indigo-900 to-purple-900 rounded-xl shadow-2xl p-6 mb-12 transform transition hover:scale-[1.02] duration-300 border border-indigo-500/30 gaming-card">
                    <div class="flex justify-between items-center">
                        <div>
                            <h3 class="text-xl font-semibold text-indigo-200 opacity-90">Valor total del equipo</h3>
                            <p class="text-indigo-300 mt-1">Actualizado en tiempo real</p>
                        </div>
                        <span class="text-3xl font-bold text-white bg-indigo-900/50 px-4 py-2 rounded-lg border border-indigo-500/50">
                ...
                <div class="bg-gradient-to-r from-indigo-900 to-purple-900 rounded-xl shadow-2xl p-6 mb-12 transform transition hover:scale-[1.02] duration-300 border border-indigo-500/30 gaming-card">
                    <div class="flex justify-between items-center">
                        <div>
                            <h3 class="text-xl font-semibold text-indigo-200 opacity-90">Presupuesto del equipo</h3>
                            <p class="text-indigo-300 mt-1">Actualizado en tiempo real</p>
                        </div>
                        <span class="text-3xl font-bold text-white bg-indigo-900/50 px-4 py-2 rounded-lg border border-indigo-500/50">
                ...
                <div class="relative mb-16 group">
                    ...
                    <div class="relative bg-gray-800 rounded-lg overflow-hidden shadow-xl flex justify-center items-center p-1 border border-purple-500/30">
                        <!-- Mapa base -->
                        <img src="{{ asset('Imagenes/mapa_light.svg') }}" alt="Mapa de League of Legends" 
                            class="w-full max-w-3xl h-auto rounded-md border-2 border-gray-700 shadow-lg">
                ...
                <div class="mb-12 flex justify-end">
                    <div class="bg-gradient-to-r from-indigo-900 to-purple-900 rounded-xl shadow-lg p-3 transform transition hover:scale-[1.05] duration-300 inline-flex justify-center items-center animate-pulse max-w-xs border border-indigo-500/50">
                ...
                <div class="mb-12">
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-2xl font-bold text-white">Tus Jugadores</h3>
                        <span class="px-4 py-2 bg-indigo-900/50 text-indigo-200 rounded-full text-sm font-medium border border-indigo-500/30">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8">
                        @foreach($jugadoresEquipo as $jugador)
                            <div class="relative bg-gray-800 rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-700 gaming-card">
                                <!-- Encabezado de la tarjeta -->
                                <div class="absolute top-3 left-3 right-3 flex justify-between items-start z-10">
                                    <!-- Logo equipo real -->
                                    <div class="bg-gray-900 rounded-full p-1 shadow-md border border-gray-700">
                                        <img src="{{ $logosEquipos[$jugador->equipo_real] ?? '' }}" 
                                            class="w-8 h-8 rounded-full object-contain">
                                    </div>
                                
                                    <!-- Icono posición -->
                                    <div class="bg-gray-900 rounded-full p-1.5 shadow-md flex items-center border border-gray-700">
                                ...
                                <div class="h-40 overflow-hidden relative">
                                    ...
                                    <div class="absolute bottom-0 left-0 p-4 w-full">
                                        ...
                                        <div class="flex items-center mt-1">
                                            <span class="text-indigo-300 text-sm font-medium bg-black/30 px-2 py-0.5 rounded border border-indigo-500/30">
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="grid grid-cols-3 gap-2 mt-4 text-center">
                                        <div class="bg-blue-900/50 p-2 rounded-lg border border-blue-500/30">
                                            <p class="text-xs text-blue-300">Kills</p>
                                            <p class="font-bold text-blue-200">{{ $jugador->estadisticas->kills }}</p>
                                        </div>
                                        <div class="bg-purple-900/50 p-2 rounded-lg border border-purple-500/30">
                                            <p class="text-xs text-purple-300">Deads</p>
                                            <p class="font-bold text-purple-200">{{ $jugador->estadisticas->muertes ?? '-' }}</p>
                                        </div>
                                        <div class="bg-green-900/50 p-2 rounded-lg border border-green-500/30">
                                            <p class="text-xs text-green-300">Asist</p>
                                            <p class="font-bold text-green-200">{{ $jugador->estadisticas->asistencias ?? '-' }}</p>
                                        </div>
                                    </div>
                        ...
                        <div id="venta-modal" class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 hidden">
                            <div class="bg-gray-900 border-2 border-amber-500 rounded-xl p-6 max-w-md w-full mx-4 gaming-modal">
                                <div class="text-center">
                                    ...
                                    <div class="flex justify-center space-x-4">
                                        <button onclick="document.getElementById('venta-modal').classList.add('hidden')" 
                                                class="bg-gray-700 hover:bg-gray-600 text-white px-6 py-2 rounded-lg border border-gray-600 transition gaming-button">
                                            Cancelar
                                        </button>
                                        <button id="confirmar-venta-btn" 
                                                class="bg-amber-600 hover:bg-amber-500 text-white px-6 py-2 rounded-lg border border-amber-500 transition gaming-button">
                                            Confirmar Venta
                                        </button>
                                    </div>
                                </div>
                    ...
                    @else
                        <div class="text-center py-12 bg-gray-800 rounded-xl shadow-md border border-gray-700">
                            ...
                            <h3 class="mt-4 text-lg font-medium text-gray-200">No tienes jugadores en este equipo</h3>
                            <p class="mt-1 text-gray-400">Añade jugadores para comenzar a competir</p>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <style>
            ...
            @keyframes neon-pulse {
                ...
                to {
                    text-shadow: 0 0 10px rgba(167, 139, 250, 0.7), 0 0 20px rgba(167, 139, 250, 0.5);
                }
            }
